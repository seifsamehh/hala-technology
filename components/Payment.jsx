      ...
      >
        <div className="flex items-center justify-start gap-4 mb-8 title">
          ...
          <Parallax speed={4}>
            ...
            >
              وسائل التعاقد والدفع
            </h2>
          </Parallax>
        </div>
        <div className="flex flex-col items-start justify-start min-[290px]:gap-12 md:gap-44 payment-content">
          <div className="top w-full flex items-center justify-start gap-4 right bg-[#fdd204] p-4 rounded-lg border-4 border-solid border-[#f5f5fa] dark:border-[#12784c]">
            ...
            <p className="font-bold dark:text-[#1f1f29]">
              يتم تقييم المنتجات بالجنية المصري والسعر موحد لجميع الدول .
            </p>
          </div>
          <div className="middle w-full p-12 rounded-lg bg-[#fdd204]">
            <Parallax speed={6}>
              <h3 className="text-6xl text-[#12784c] font-bold">
                10 % <br />
                خصم
              </h3>
              ...
              <p className="dark:text-[#1f1f29]">
                كما يمكنك الدفع بالريال السعودي او الجنية المصري .
              </p>
              <p className="dark:text-[#1f1f29]">
                يتم تقييم المنتجات بالجنية المصري والسعر موحد لجميع الدول .
              </p>
          ...
          <div className="bottom">
            <Parallax speed={5}>
              <h3
                className={`text-3xl text-[#12784c] dark:text-[#fdd204] mb-12 font-bold ${kufam.className}`}
              >
                يمكنك الدفع من خلال الوسائل التالية
              </h3>
            </Parallax>
              ...
              <div className="right">
                <div className="flex items-center justify-center gap-6 min-[290px]:flex-wrap md:flex-nowrap boxs">
                  <div className="flex flex-col items-center justify-center h-48 gap-4 p-6 bg-white rounded-lg border-2 border-dashed border-[#12784c] dark:border-[#fdd204] w-44 box">
                    ...
                    <p className="dark:text-[#1f1f29]">المحفظة الرقمية</p>
                  </div>
                  <div className="flex flex-col items-center justify-center h-48 gap-4 p-6 bg-white rounded-lg border-2 border-dashed border-[#12784c] dark:border-[#fdd204] w-44 box">
                    <Image
                      src="/payment4.webp"
                  ...
                  <div className="flex flex-col items-center justify-center h-48 gap-4 p-6 bg-white rounded-lg border-2 border-dashed border-[#12784c] dark:border-[#fdd204] w-44 box">
                    ...
                    <p className="dark:text-[#1f1f29]">شركة خدمات مالية</p>
                  </div>
                  <div className="flex flex-col items-center justify-center h-48 gap-4 p-6 bg-white rounded-lg border-2 border-dashed border-[#12784c] dark:border-[#fdd204] w-44 box">
                    <Image
                      src="/payment3.webp"
                    ...
                    <p className="dark:text-[#1f1f29]">بنك الراجحي</p>
                  </div>
                </div>
              </div>
              <div className="left">
