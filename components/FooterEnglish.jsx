...
const FooterEnglish = () => {
  const shareGolden = async () => {
    try {
      await navigator.share({
        ...
        text: "Golden Invites You To Visit Campaign Website",
  ...
  const shareDir = async () => {
    try {
      await navigator.share({
        title: "Hala Technology",
        text: "Dir Invites You To Visit Campaign Website",
        url: "https://hala-technology.vercel.app/",
      });
      console.log("Shared successfully!");
    } catch (error) {
  ...
  const sharePathfinder = async () => {
    try {
      await navigator.share({
        title: "Hala Technology",
        text: "Pathfinder Invites You To Visit Campaign Website",
        url: "https://hala-technology.vercel.app/",
      });
      console.log("Shared successfully!");
    } catch (error) {
  ...
  return (
    <footer className="footer min-[290px]:flex flex-row md:justify-around min-[290px]:justify-start items-start min-[290px]:flex-wrap min-[290px]:py-12 md:p-10 min-[290px]:pl-6 md:pl-0 bg-[#11784b] text-white">
      <div className="golden-hornet">
        ...
        <div className="social-media">
          <span className="text-xl text-white">Let&apos;s keep in touch</span>
      ...
      <div className="flex flex-col items-start justify-center location">
        <span className="text-2xl text-white">Our Location</span>
        <iframe
