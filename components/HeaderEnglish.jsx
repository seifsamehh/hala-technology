...
const HeaderEnglish = () => {
  ...
  const sectionRefs = useMemo(
    () => [
      { sectionId: "heroo", label: "Home" },
      { sectionId: "about-us", label: "About Us" },
      { sectionId: "work", label: "Previous Work" },
      { sectionId: "partners", label: "Partners" },
      { sectionId: "offers", label: "Offers" },
      { sectionId: "uses", label: "Uses" },
      { sectionId: "payment", label: "Payment Methods" },
    ],
    []
  );
